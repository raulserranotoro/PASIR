			...
			<body>
				...
				<main>
					...
					<form action="modificar lectores.php" method="POST">
						...
						<br>
						<input type="text" placeholder="Ingrese su email" id="email" name="email" pattern="^[a-z0-9._%+-]+@[a-z0-9-]+.+.[a-z]{2,4}$" title="El correo electrónico no cumple con los requisitos." value="<?php echo $email; ?>"/>
						<br>
