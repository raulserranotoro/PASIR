<?php
	...
	//Crea una sesión.
	session_start ();
	//Si ambas variables están definidas (el usuario ha iniciado sesión), muestra el contenido de "categorias.php".
...
?>
		...
		<html lang="es">
			...
			<body>
				...
				<main>
					<input type="text" placeholder="Buscar por categoría..." id="buscador" name="buscador" onkeyup="buscador ()"/>
					<script>
						function buscador (){
							//Declarar variables.
					...
					<?php
						...
						//Si la conexión ha dado error, muestra una alerta por pantalla y te redirecciona a "categorias.php".
						if ($connection->connect_errno){
							echo "<script>alert ('No hay conexión: (".$connection->connect_errno.")".$connection->connect_error.".'); window.location='categorias.php'</script>";
						}
						//La variable "$query" guarda el resultado de la consulta realizada.
						$query=mysqli_query ($connection, "SELECT * FROM categorias");
						echo "<table id='tabla'>";
						echo "<caption>Categorías</caption>";
						echo "<tr>";
					...
					?>
					<a class="boton" href="./insertar categorias.php">Insertar</a>
					<a class="boton" href="./modificar categorias.php">Modificar</a>
					<a class="boton" href="./borrar categorias.php">Borrar</a>
				</main>
				<footer>
					<p>
