<?php
	...
	//Crea una sesión.
	session_start ();
	//Si ambas variables están definidas (el usuario ha iniciado sesión), muestra el contenido de "editoriales.php".
...
?>
		...
		<html lang="es">
			...
			<body>
				...
				<main>
					<input type="text" placeholder="Buscar por editorial..." id="buscador" name="buscador" onkeyup="buscador ()"/>
					<script>
						function buscador (){
							//Declarar variables.
					...
					<?php
						...
						//Si la conexión ha dado error, muestra una alerta por pantalla y te redirecciona a "editoriales.php".
						if ($connection->connect_errno){
							echo "<script>alert ('No hay conexión: (".$connection->connect_errno.")".$connection->connect_error.".'); window.location='editoriales.php'</script>";
						}
						//La variable "$query" guarda el resultado de la consulta realizada.
						$query=mysqli_query ($connection, "SELECT * FROM editoriales");
						echo "<table id='tabla'>";
						echo "<caption>Editoriales</caption>";
						echo "<tr>";
					...
					?>
					<a class="boton" href="./insertar editoriales.php">Insertar</a>
					<a class="boton" href="./modificar editoriales.php">Modificar</a>
					<a class="boton" href="./borrar editoriales.php">Borrar</a>
				</main>
				<footer>
					<p>
